/* ==============================================================================
* Description：拷贝的MvvmLigth的RelayCommand代码  
* Author     ：litao
...
namespace TestHelper
{
    ...
    public class MvvmLightRelayCommand : ICommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MvvmLightRelayCommand class that 
        /// can always execute.
        /// </summary>
        ...
        public MvvmLightRelayCommand(Action execute) : this(execute, null)
        {
        }

        /// <summary>
        /// Initializes a new instance of the MvvmLightRelayCommand class.
        /// </summary>
        /// <param name="execute">The execution logic. IMPORTANT: Note that closures are not supported at the moment
        /// due to the use of WeakActions (see http://stackoverflow.com/questions/25730530/). </param>
        ...
        public MvvmLightRelayCommand(Action execute, Func<bool> canExecute)
        {
            if (execute == null)
            {
        ...
        /// <summary>
        /// Raises the <see cref="E:TestHelper.MvvmLightRelayCommand.CanExecuteChanged" /> event.
        /// </summary>
    ...
    public class WeakFunc<TResult>
    {
        ...
        /// <see cref="P:TestHelper.WeakFunc`1.Reference" />, for example if the
        /// method is anonymous.
        /// </summary>
        ...
        /// <see cref="P:TestHelper.WeakFunc`1.FuncReference" />, for example if the
        /// method is anonymous.
        /// </summary>
        ...
        /// This is not necessarily the same as
        /// <see cref="P:TestHelper.WeakFunc`1.Target" />, for example if the
        /// method is anonymous.
        /// </summary>
    ...
    public class WeakAction
    {
        ...
        /// This is not necessarily the same as
        /// <see cref="P:TestHelper.WeakAction.Reference" />, for example if the
        /// method is anonymous.
        /// </summary>
        ...
        /// <see cref="P:TestHelper.WeakAction.ActionReference" />, for example if the
        /// method is anonymous.
        /// </summary>
        protected WeakReference Reference
        {
        ...
        /// <summary>
        /// Initializes an empty instance of the <see cref="T:TestHelper.WeakAction" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:TestHelper.WeakAction" /> class.
        /// </summary>
